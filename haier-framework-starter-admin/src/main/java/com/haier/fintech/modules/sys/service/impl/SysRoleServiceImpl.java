...
import com.haier.fintech.modules.sys.dao.SysRoleDao;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleDao, SysRoleEntity> implements SysRoleService {
	...
	private void checkPrems(SysRoleEntity role){
		...
		//role.getCreateUserId() == Constant.SUPER_ADMIN
		if(isDev || role.getCreateUserId() == Constant.SUPER_ADMIN){
			return ;
		}
		...
		if(!menuIdList.containsAll(role.getMenuIdList())){
			throw new HaierException("新增角色的权限，已超出你的权限范围");
		}
	}
